...
%--------------------------------------------------------------------------
%
%  function layers = dme_segmentImage(image, params)
%
%  INPUT PARAMETERS:
%
...
%                 set by the dme_getParameters function
%
%  OUTPUT VARIABLES:
%
...
function layers = dme_segmentImage(image, params)
    ...
    [bwImage, borders] = dme_getBwImage( ...
    ...
    [image,pixelShift,invalidIndices] = dme_flattenImage(image, rpeBottom);
    ...
    if params.otherParams.SEGMENT_CYSTS  
        params.otherParams.INVALID_IMAGE = originalInvalidImage;
        params.otherParams.TOP_LAYER = layers(1,:);
        params.otherParams.BOTTOM_LAYER = layers(2,:);
        
        cystParams = dme_cysts_getParameters();
        params.getBwImageParams = cystParams.getBwImageParams;
        params.graphCutParams = cystParams.graphCutParams;
        
        cystImage = dme_cysts_segmentImage(originalImage,params);
